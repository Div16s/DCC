...
class Solution
{
    ...
    Node *sortedInsert(Node* head, int data)
    {
       ...
       if(!head){
           newNode->next = newNode; //Since the linkedlist is circular
           return newNode;
       }
       
       //Case2: If the data at head is greater than the data to be inserted
       if(head->data >= data){
           Node* curr = head;
       ...
       //Case3: Insertion in the middle/end
       Node* curr = head;
